...
public partial class MainForm : Form
{
    ...
    public void openWz(string wzFilePath)
    {
        ...
        Wz.IsDataWz = false;
        var mobNode = Wz.GetNode("Mob");
        if (mobNode != null && mobNode.FullPathToFile.LeftStr(4) == "Data")
            Wz.IsDataWz = true;
    ...
    static readonly Pen pen = new(System.Drawing.Color.FromArgb(153, 180, 209), 2);
